...
* The original package name 'se.magnus.microservices.core.product-composite-service' is invalid and this project uses 'se.magnus.microservices.core.product_composite_service' instead.
